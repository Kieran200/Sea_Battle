...
namespace Sea_Battle
{
    ...
    {
        public void InsallShip(string[,] invisiblefield, Player player)
        {
            int count = 0;
        ...
        M: int x = rnd.Next(3, 13);
            ...
            A: int x1 = rnd.Next(3, 13);
                ...
                player.Neighbor(invisiblefield, x1, y1, out stop1, 13, 13);     //проверка соседей для 3хпалубного
                stop += stop1;


                player.Neighbor(invisiblefield, x1 + 1, y1, out stop1, 13, 13);
                stop += stop1;
                player.Neighbor(invisiblefield, x1 + 2, y1, out stop1, 13, 13);
                stop += stop1;


                player.Neighbor(invisiblefield, x1, y1 + 1, out stop1, 13, 13);
                stop += stop1;
                player.Neighbor(invisiblefield, x1, y1 + 2, out stop1, 13, 13);
                stop += stop1;
            ...
            A: int x1 = rnd.Next(3, 13);
                ...
                player.Neighbor(invisiblefield, x1, y1, out stop1, 13, 13);     //проверка соседей для 2хпалубного
                stop += stop1;
            ...
            A: int x1 = rnd.Next(3, 13);
                ...
                player.Neighbor(invisiblefield, x1, y1, out stop1, 13, 13);     //проверка соседей для 1палубного
                stop += stop1;
